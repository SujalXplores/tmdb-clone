export const Certifications = {
  ...
  PH: [
    ...
    },
    {
      certification: 'PG',
      meaning:
        'Parental Guidance. Viewers below 13 years old must be accompanied by a parent or supervising adult.',
      order: 2,
    },
    {
      certification: 'R-13',
      meaning:
        'Restricted-13. Only viewers who are 13 years old and above can be admitted.',
      order: 3,
    },
    {
      certification: 'R-16',
      meaning:
        'Restricted-16. Only viewers who are 16 years old and above can be admitted.',
      order: 4,
    },
    {
      certification: 'R-18',
      meaning:
        'Restricted-18. Only viewers who are 18 years old and above can be admitted.',
      order: 5,
    },
    {
      certification: 'X',
      meaning:
        'Not For Public Exhibition. X-rated films are not suitable for public exhibition.',
      order: 6,
    },
  ],
  PT: [
